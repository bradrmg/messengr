...
/*
 * $themes_config['xact_darkly']['main'] = array( 'default_inc' => 'feature_report', 'default_route' => 'user', 'default_op' => '', );
 */

// override common action icons
/*
 * $themes_config['xact_darkly']['icon'] = array( 'edit' => "<span class='playsms-icon glyphicon glyphicon-cog' alt='"._('Edit')."' title='"._('Edit')."'></span>", 'delete' => "<span class='playsms-icon glyphicon glyphicon-trash' alt='"._('Delete')."' title='"._('Delete')."'></span>", );
 */

// override menus
/*
$themes_config['xact_darkly']['menu'] = array(
